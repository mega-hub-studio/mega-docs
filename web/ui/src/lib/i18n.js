...
export const messages = {
  en: {
    ...
    settings: {
      ...
      answering: 'Answering',
      model: 'Model',
      modelHint: 'Rides on every question. This instance refuses any other.',
      oneModel: 'This instance answers with one model.',
      window: '{n} token window',
      price: 'USD per 1M tokens (in / out)',
      unpriced: 'No price configured',
      memory: 'Memory',
      recall: '{kept} of {offered} turns',
      recallNone: 'Starts with your first question',
      reading: 'Reading',
      language: 'Language',
      sound: 'Sound',
  ...
  vi: {
    ...
    settings: {
      ...
      answering: 'Trả lời',
      model: 'Model',
      modelHint: 'Đi kèm mọi câu hỏi. Instance này từ chối model khác.',
      oneModel: 'Instance này trả lời bằng một model.',
      window: 'Cửa sổ {n} token',
      price: 'USD mỗi 1M token (in / out)',
      unpriced: 'Chưa cấu hình giá',
      memory: 'Bộ nhớ',
      recall: '{kept} trong {offered} lượt',
      recallNone: 'Bắt đầu từ câu hỏi đầu tiên của bạn',
      reading: 'Đọc',
      language: 'Ngôn ngữ',
      sound: 'Âm thanh',
      instance: 'Instance này',
