...
export const messages = {
  en: {
    ...
    settings: {
      ...
      language: 'Language',
      sound: 'Sound',
      websearch: 'Also look outside the documents',
      websearchHint: 'Adds public web results, labelled and listed separately. It sends your question to a search provider.',
  ...
  vi: {
    ...
    settings: {
      ...
      language: 'Ngôn ngữ',
      sound: 'Âm thanh',
      websearch: 'Tìm thêm ngoài tài liệu',
      websearchHint: 'Thêm kết quả web công khai, có nhãn và liệt kê riêng. Nó gửi câu hỏi của bạn tới một nhà cung cấp tìm kiếm.',
